...
export default function PCOS() {
  ...
  const MEAL_OPTIONS = [
    ...
    "Stir-fried tofu & greens with brown rice",
    "Steel-cut oats with nuts & cinnamon",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {step >= 2 && (
          <section id="mealSelection" className="bg-white p-6 rounded-2xl shadow-sm mb-6">
            ...
            <p className="text-sm text-gray-600 mb-4">Choose the meals you'd like prioritized in your PCOS plan.</p>
                ...
                return (
                  <label key={m} className={`flex items-center gap-3 p-3 rounded-lg border ${checked ? "border-indigo-500 bg-indigo-50" : "border-gray-200 bg-white"}`}>
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">Low-glycemic, fibre-rich choice</div>
                    </div>
                  </label>
                );
              })}
