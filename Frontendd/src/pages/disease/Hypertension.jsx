...
export default function Hypertension() {
  ...
  const diseaseName = "hypertension";
  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (u) => {
      ...
      try {
        ...
        console.warn("Could not fetch Hypertension profile:", e);
      }
    });
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.hypertension.proteins.map(item => (
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.hypertension.carbs.map(item => (
                    <label key={item} className="flex items-center gap-2">
                      <input
                        type="checkbox"
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.hypertension.vitamins.map(item => (
                    <label key={item} className="flex items-center gap-2">
                      <input
                        type="checkbox"
