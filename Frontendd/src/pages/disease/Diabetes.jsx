  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (u) => {
      ...
      try {
        ...
        console.warn("Could not fetch Diabetes profile:", e);
      }
    });
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.diabetes.proteins.map(item => (
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.diabetes.carbs.map(item => (
                    <label key={item} className="flex items-center gap-2">
                      <input
                        type="checkbox"
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.diabetes.vitamins.map(item => (
                    <label key={item} className="flex items-center gap-2">
                      <input
                        type="checkbox"
