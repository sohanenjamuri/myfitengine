...
export default function PCOS() {
  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (u) => {
      ...
      try {
        ...
        console.warn("Could not fetch PCOS profile:", e);
      }
    });
  ...
  const handleCalculatePlan = async () => {
    ...
    const workout = planWorkout(profile, diseaseName) || { items: WORKOUT_OPTIONS };
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.pcos.proteins.map(item => (
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.pcos.carbs.map(item => (
                    <label key={item} className="flex items-center gap-2">
                      <input
                        type="checkbox"
              ...
              <div>
                ...
                <div className="space-y-2">
                  {INGREDIENTS.pcos.vitamins.map(item => (
                    <label key={item} className="flex items-center gap-2">
                      <input
                        type="checkbox"
